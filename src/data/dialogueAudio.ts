...
if (typeof window !== 'undefined' && !Object.keys(recordings).length) {
  console.warn('[audio] No approved human dialogue recordings are bundled (src/data/dialogueAudio.generated.json is empty). Lines are read by the device voice where available. See docs/audio-production.md.');
}
