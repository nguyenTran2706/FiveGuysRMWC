/**
 * Helpers for optionally reading story lines with the device's built-in voice (Web Speech API)
 * when no matching MP3 exists. Only fixed story text is spoken, never anything a visitor typed.
 */
